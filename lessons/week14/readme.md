...
* 1-1 Conferences
    ...
    *    ALL Teams (Required): Complete the [Recursion Exercise](../unit12/code/recursion)
    *    (Optional Extra Credit): [Complex Numbers and Mandelbrot Set](../unit13/plan/complexnum) Code Extracts in Slack in [#advteamch](https://app.slack.com/client/TTS9Y46VC/GUQC6EUDC) or [#stdteamch](https://app.slack.com/client/TTS9Y46VC/GUQC6EUDC) channels
    *    (Optional Extra Credit): [Recursion with Translate and Rotate](../unit13/code/tree_v3) Code Extracts in [Slack general channel](https://app.slack.com/client/TTS9Y46VC/CTCKE2LDR)

### This Unit's Exercises - Last Assignment of the class!
