...
// This will eventualy come from a file of input values
  ...
  MatrixUtil.mprint("printing inputs to neural network", inp);  
...
// This will eventualy come from a file of input values
  ...
  MatrixUtil.mprint("printing targets for neural network", tgt);  
  ...
  MatrixUtil.mprint("printing final output from neural network", out);  
